...
import br.com.cartaodevisita.databinding.ItemCartaoVisitaBinding

class BusinessCartaoAdapter : ListAdapter<CartaoVisita, BusinessCartaoAdapter.ViewHolder>(DiffCallback()) {
